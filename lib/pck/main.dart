...
//   var _cl = (var tar, num flag) => tar == flag ? Colors.orangeAccent : Colors.blue[350];
...
//               width: 80,
//               child: FlatButton(
//                   color: _cl(ListenerBox.instance['page'].value, 1),
//                   child: Text("主  页"),
//                   onPressed: () {
//                     setState(() {
//                       ListenerBox.instance['page'].value = 1;
...
//               width: 80,
//               child: FlatButton(
//                   color: _cl(ListenerBox.instance['page'].value, 2),
//                   child: Text("目录页"),
//                   onPressed: () {
//                     setState(() {
//                       ListenerBox.instance['page'].value = 2;
...
//               width: 80,
//               child: FlatButton(
//                   color: _cl(ListenerBox.instance['page'].value, 3),
//                   child: Text("阅读页"),
//                   onPressed: () {
//                     setState(() {
//                       ListenerBox.instance['page'].value = 3;
...
//               width: 80,
//               child: FlatButton(
//                   color: _cl(ListenerBox.instance['page'].value, 4),
//                   child: Text("设置页"),
//                   onPressed: () {
//                     setState(() {
...
//         body: WillPopScope(
//             onWillPop: () {
//               ListenerBox.instance['page'].value =
//                   ListenerBox.instance['page'].value > 1 ? ListenerBox.instance['page'].value - 1 : 1;
//               return new Future.value(false);
//             },
//             child: Container(child: getpage())));
//   }
